...
import static org.firstinspires.ftc.teamcode.supermanTESTER.Globals.ALLIANCE;
import static org.firstinspires.ftc.teamcode.supermanTESTER.Globals.SIDE;
...
public class PropPipeline implements VisionProcessor {
    ...
    public static int redCenterY = (int) (775);
    public static int blueCenterX = (int) (240);
    public static int blueCenterY = (int) (1425);
